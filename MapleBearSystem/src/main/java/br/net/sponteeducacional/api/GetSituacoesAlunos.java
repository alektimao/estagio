...
public class GetSituacoesAlunos  implements java.io.Serializable {
    private int nCodigoCliente;

    private java.lang.String sToken;

    public GetSituacoesAlunos() {
    }
    ...
    /**
     * Gets the nCodigoCliente value for this GetSituacoesAlunos.
     * 
    ...
    /**
     * Sets the nCodigoCliente value for this GetSituacoesAlunos.
     * 
    ...
    /**
     * Gets the sToken value for this GetSituacoesAlunos.
     * 
     * @return sToken
     */
    ...
    /**
     * Sets the sToken value for this GetSituacoesAlunos.
     * 
     * @param sToken
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof GetSituacoesAlunos)) return false;
        GetSituacoesAlunos other = (GetSituacoesAlunos) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GetSituacoesAlunos.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://api.sponteeducacional.net.br/", ">GetSituacoesAlunos"));
