...
public class WsItens  implements java.io.Serializable {
    private java.lang.String retornoOperacao;

    private br.net.sponteeducacional.api.Itens[] itens;
    ...
    public WsItens(
           ...
           br.net.sponteeducacional.api.Itens[] itens) {
    ...
    /**
     * Gets the retornoOperacao value for this WsItens.
     * 
    ...
    /**
     * Sets the retornoOperacao value for this WsItens.
     * 
    ...
    /**
     * Gets the itens value for this WsItens.
     * 
     * @return itens
     */
    public br.net.sponteeducacional.api.Itens[] getItens() {
        return itens;
    }


    /**
     * Sets the itens value for this WsItens.
     * 
     * @param itens
     */
    public void setItens(br.net.sponteeducacional.api.Itens[] itens) {
        this.itens = itens;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof WsItens)) return false;
        WsItens other = (WsItens) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(WsItens.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://api.sponteeducacional.net.br/", "wsItens"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://api.sponteeducacional.net.br/", "Itens"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setItemQName(new javax.xml.namespace.QName("http://api.sponteeducacional.net.br/", "Itens"));
        typeDesc.addFieldDesc(elemField);
    }
