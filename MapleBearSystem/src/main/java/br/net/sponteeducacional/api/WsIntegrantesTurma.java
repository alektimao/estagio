...
public class WsIntegrantesTurma  implements java.io.Serializable {
    ...
    private br.net.sponteeducacional.api.Integrantes[] integrantes;

    public WsIntegrantesTurma() {
    }
    ...
    public WsIntegrantesTurma(
           ...
           br.net.sponteeducacional.api.Integrantes[] integrantes) {
    ...
    /**
     * Gets the retornoOperacao value for this WsIntegrantesTurma.
     * 
    ...
    /**
     * Sets the retornoOperacao value for this WsIntegrantesTurma.
     * 
    ...
    /**
     * Gets the matrizCurricularID value for this WsIntegrantesTurma.
     * 
    ...
    /**
     * Sets the matrizCurricularID value for this WsIntegrantesTurma.
     * 
    ...
    /**
     * Gets the nome value for this WsIntegrantesTurma.
     * 
     * @return nome
     */
    ...
    /**
     * Sets the nome value for this WsIntegrantesTurma.
     * 
     * @param nome
     */
    ...
    /**
     * Gets the integrantes value for this WsIntegrantesTurma.
     * 
     * @return integrantes
     */
    public br.net.sponteeducacional.api.Integrantes[] getIntegrantes() {
        return integrantes;
    }


    /**
     * Sets the integrantes value for this WsIntegrantesTurma.
     * 
     * @param integrantes
     */
    public void setIntegrantes(br.net.sponteeducacional.api.Integrantes[] integrantes) {
        this.integrantes = integrantes;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof WsIntegrantesTurma)) return false;
        WsIntegrantesTurma other = (WsIntegrantesTurma) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(WsIntegrantesTurma.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://api.sponteeducacional.net.br/", "wsIntegrantesTurma"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://api.sponteeducacional.net.br/", "Integrantes"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://api.sponteeducacional.net.br/", "Integrantes"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setItemQName(new javax.xml.namespace.QName("http://api.sponteeducacional.net.br/", "Integrantes"));
        typeDesc.addFieldDesc(elemField);
    }
