...
public class GetSituacoesAlunosTurma  implements java.io.Serializable {
    private int nCodigoCliente;

    private java.lang.String sToken;

    public GetSituacoesAlunosTurma() {
    }
    ...
    /**
     * Gets the nCodigoCliente value for this GetSituacoesAlunosTurma.
     * 
    ...
    /**
     * Sets the nCodigoCliente value for this GetSituacoesAlunosTurma.
     * 
    ...
    /**
     * Gets the sToken value for this GetSituacoesAlunosTurma.
     * 
     * @return sToken
     */
    ...
    /**
     * Sets the sToken value for this GetSituacoesAlunosTurma.
     * 
     * @param sToken
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof GetSituacoesAlunosTurma)) return false;
        GetSituacoesAlunosTurma other = (GetSituacoesAlunosTurma) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GetSituacoesAlunosTurma.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://api.sponteeducacional.net.br/", ">GetSituacoesAlunosTurma"));
