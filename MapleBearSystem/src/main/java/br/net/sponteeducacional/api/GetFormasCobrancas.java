...
public class GetFormasCobrancas  implements java.io.Serializable {
    private int nCodigoCliente;

    private java.lang.String sToken;

    public GetFormasCobrancas() {
    }
    ...
    /**
     * Gets the nCodigoCliente value for this GetFormasCobrancas.
     * 
    ...
    /**
     * Sets the nCodigoCliente value for this GetFormasCobrancas.
     * 
    ...
    /**
     * Gets the sToken value for this GetFormasCobrancas.
     * 
     * @return sToken
     */
    ...
    /**
     * Sets the sToken value for this GetFormasCobrancas.
     * 
     * @param sToken
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof GetFormasCobrancas)) return false;
        GetFormasCobrancas other = (GetFormasCobrancas) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GetFormasCobrancas.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://api.sponteeducacional.net.br/", ">GetFormasCobrancas"));
