...
public class GetOrigensAlunos  implements java.io.Serializable {
    private int nCodigoCliente;

    private java.lang.String sToken;

    public GetOrigensAlunos() {
    }
    ...
    /**
     * Gets the nCodigoCliente value for this GetOrigensAlunos.
     * 
    ...
    /**
     * Sets the nCodigoCliente value for this GetOrigensAlunos.
     * 
    ...
    /**
     * Gets the sToken value for this GetOrigensAlunos.
     * 
     * @return sToken
     */
    ...
    /**
     * Sets the sToken value for this GetOrigensAlunos.
     * 
     * @param sToken
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof GetOrigensAlunos)) return false;
        GetOrigensAlunos other = (GetOrigensAlunos) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GetOrigensAlunos.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://api.sponteeducacional.net.br/", ">GetOrigensAlunos"));
