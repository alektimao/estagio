...
public class MapleBearSystemProductTest extends Application {
	...
	private void initProgramStage(Stage primaryStage, boolean doInitConfig) {
		...
		try {
			...
			root = FXMLLoader.load(MapleBearSystemProductTest.class.getResource(FXMLResourcePathsEnum.FXML_MAPLE_PRODUCTMANAGER.getPath()));
